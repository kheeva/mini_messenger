...
const file_auth_service_proto_rawDesc = "" +
	"\n" +
	"\x12auth/service.proto\x12%github.com.kheeva.mini_messenger.auth\x1a\x12auth/message.proto2\xfe\x02\n" +
	"\vAuthService\x12}\n" +
	...
	"\aRefresh\x125.github.com.kheeva.mini_messenger.auth.RefreshRequest\x1a6.github.com.kheeva.mini_messenger.auth.RefreshResponse\"\x00B\x82\x02\n" +
	")com.github.com.kheeva.mini_messenger.authB\fServiceProtoP\x01Z\x11pkg/api/auth;auth\xa2\x02\x05GCKMA\xaa\x02$Github.Com.Kheeva.MiniMessenger.Auth\xca\x02$Github\\Com\\Kheeva\\MiniMessenger\\Auth\xe2\x020Github\\Com\\Kheeva\\MiniMessenger\\Auth\\GPBMetadata\xea\x02(Github::Com::Kheeva::MiniMessenger::Authb\x06proto3"
