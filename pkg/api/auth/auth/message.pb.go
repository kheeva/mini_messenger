...
const file_auth_message_proto_rawDesc = "" +
	"\n" +
	"\x12auth/message.proto\x12%github.com.kheeva.mini_messenger.auth\x1a\x1bbuf/validate/validate.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\"C\n" +
	...
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12#\n" +
	"\rrefresh_token\x18\x02 \x01(\tR\frefreshToken\x12\x17\n" +
	"\auser_id\x18\x03 \x01(\tR\x06userIdB\x82\x02\n" +
	")com.github.com.kheeva.mini_messenger.authB\fMessageProtoP\x01Z\x11pkg/api/auth;auth\xa2\x02\x05GCKMA\xaa\x02$Github.Com.Kheeva.MiniMessenger.Auth\xca\x02$Github\\Com\\Kheeva\\MiniMessenger\\Auth\xe2\x020Github\\Com\\Kheeva\\MiniMessenger\\Auth\\GPBMetadata\xea\x02(Github::Com::Kheeva::MiniMessenger::Authb\x06proto3"

var (
	file_auth_message_proto_rawDescOnce sync.Once
	file_auth_message_proto_rawDescData []byte
)

func file_auth_message_proto_rawDescGZIP() []byte {
	file_auth_message_proto_rawDescOnce.Do(func() {
		file_auth_message_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_auth_message_proto_rawDesc), len(file_auth_message_proto_rawDesc)))
	})
